...
if (ENABLE_JEMALLOC)
    if (USE_INTERNAL_JEMALLOC_LIBRARY AND NOT EXISTS "${CMAKE_SOURCE_DIR}/contrib/jemalloc/src/jemalloc.c")
    ...
    if ((NOT JEMALLOC_LIBRARIES OR NOT JEMALLOC_INCLUDE_DIR) AND NOT MISSING_INTERNAL_JEMALLOC_LIBRARY AND NOT ARCH_ARM)
        ...
        set (JEMALLOC_INCLUDE_DIR "${CMAKE_SOURCE_DIR}/contrib/jemalloc-cmake/include" "${CMAKE_SOURCE_DIR}/contrib/jemalloc-cmake/include_linux_x86_64")
